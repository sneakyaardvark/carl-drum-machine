    ...
    for (int address = 1; address < 128; address++){
        ...
        switch(error){
            case 0: // add recognized devices to device id index
                ...
                Serial.print("mappable device found at ");
                Serial.println(address);
                Serial.print("name ");
            ...
            case 4:
                ...
                Serial.print("UNK device found at ");
                Serial.println(address);
                //I2CDeviceBuild(devices, deviceName, numDevices, address, busMember);
                break;
        ...
        devices[numDevices].name = deviceName;
        devices[numDevices].index = numDevices;
        devices[numDevices].address = address;
        devices[numDevices].busMember = busMember;
        numDevices++;
...
// todo
//void CarlI2C::screenGfx(int token){}
